...
const SaddProduct = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.imgSrc.length === 0)
      newErrors.imgSrc = "At least one image is required";
    return newErrors;
  };
  ...
  return (
    <div
      className="container mt-2 bg-success p-3 rounded text-white"
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          <label htmlFor="images" className="form-label">
            Product Images (Multiple At Once)
          </label>
          <input
            type="file"
          ...
          />
          {errors.imgSrc && (
            <div className="invalid-feedback">{errors.imgSrc}</div>
          )}
        </div>
